"""«Войти как» — временно смотреть кабинет глазами другого пользователя: от
обычного участника (активист/член Братства/выпускник — по статусу в
«Составе», см. GROUPS ниже) до любой управленческой роли.

Кнопка видна федеральным координаторам (и техническому superuser — задел на
переходный период, план «Убираем технического superuser»): проверка идёт по
telegram_id напрямую, в обход resolve_user — см. _require_admin. Раньше это
было доступно только одному техническому аккаунту; теперь — нескольким
доверенным людям сразу (utils.users.IMPERSONATOR_ROLES)."""
